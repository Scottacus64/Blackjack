...
public:
    ...
    void setupUi(QWidget *BlackjackUI)
    {
        ...
        playerLabel->setGeometry(QRect(240, 10, 350, 50));
        QFont font;
        ...
        dealerLabel->setGeometry(QRect(240, 290, 350, 50));
    ...
    void retranslateUi(QWidget *BlackjackUI)
    {
        ...
        hitButton->setText(QCoreApplication::translate("BlackjackUI", "Play Game?", nullptr));
        stayButton->setText(QCoreApplication::translate("BlackjackUI", "", nullptr));
