...
public:
    ...
    void setupUi(QWidget *BlackJack)
    {
        ...
        layoutWidget1 = new QWidget(BlackJack);
        layoutWidget1->setObjectName("layoutWidget1");
        layoutWidget1->setGeometry(QRect(10, 70, 751, 141));
        horizontalLayout = new QHBoxLayout(layoutWidget1);
        horizontalLayout->setObjectName("horizontalLayout");
        horizontalLayout->setContentsMargins(0, 0, 0, 0);
        pc_0 = new QLabel(layoutWidget1);
        ...
        label = new QLabel(BlackJack);
        label->setObjectName("label");
        label->setGeometry(QRect(110, 600, 611, 41));
        QFont font1;
    ...
    void retranslateUi(QWidget *BlackJack)
    {
        ...
        label->setText(QCoreApplication::translate("BlackJack", "Win:      Loss:     Push:", nullptr));
    } // retranslateUi
